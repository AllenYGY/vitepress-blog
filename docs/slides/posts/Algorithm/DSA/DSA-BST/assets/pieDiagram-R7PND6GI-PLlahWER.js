import{p as B}from"./chunk-K2ZEYYM2-CfZM97sX.js";import{p as U}from"./gitGraph-YCYPL57B-5MQDGNWY-QEt9hyWQ.js";import{G as q,p as H,q as V,s as Z,g as j,d as J,c as K,_ as i,l as C,x as Q,e as X,H as Y,a8 as tt,aa as et,ab as z,ac as at,m as rt,ad as it}from"./md-CHYs0oWR.js";import"./chunk-TGZYFRKZ-8wV8_anq.js";import"./index-YZXFLkQu.js";import"./modules/vue-BsAXfVut.js";import"./modules/shiki-DXe6iTno.js";import"./modules/unplugin-icons-CnyuD4gL.js";import"./slidev/context-1Izxr8fM.js";import"./modules/file-saver-LUhfcczZ.js";import"./slidev/default-BKazbJb4.js";var G=q.pie,D={sections:new Map,showData:!1,config:G},m=D.sections,w=D.showData,st=structuredClone(G),ot=i(()=>structuredClone(st),"getConfig"),nt=i(()=>{m=new Map,w=D.showData,Q()},"clear"),lt=i(({label:t,value:a})=>{m.has(t)||(m.set(t,a),C.debug(`added new section: ${t}, with value: ${a}`))},"addSection"),ct=i(()=>m,"getSections"),pt=i(t=>{w=t},"setShowData"),dt=i(()=>w,"getShowData"),F={getConfig:ot,clear:nt,setDiagramTitle:H,getDiagramTitle:V,setAccTitle:Z,getAccTitle:j,setAccDescription:J,getAccDescription:K,addSection:lt,getSections:ct,setShowData:pt,getShowData:dt},gt=i((t,a)=>{B(t,a),a.setShowData(t.showData),t.sections.map(a.addSection)},"populateDb"),ut={parse:i(async t=>{const a=await U("pie",t);C.debug(a),gt(a,F)},"parse")},ft=i(t=>`
  .pieCircle{
