...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">})</span></span></code></pre></div><p>详见<a href="/vitepress-blog/guide/1-config/3-default.html">默认配置</a></p><h2 id="背景图片设置" tabindex="-1">背景图片设置 <a class="header-anchor" href="#背景图片设置" aria-label="Permalink to &quot;背景图片设置&quot;">​</a></h2><p>前提是开启了装饰样式,即在config中设置<code>ornateStyle:true</code></p><p>我们便可以通过配置对应的markdown文件来指定背景图片</p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">---</span></span>
